...
import { FaPinterest, FaTiktok, FaXTwitter } from 'react-icons/fa6'
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Main Footer Content - Logo on Left, Links on Right */}
            ...
            <div className="flex gap-4">
              {settings.social_facebook && (
                <a
                  ...
                  aria-label="Facebook"
                >
                  <Facebook className="h-6 w-6" style={{ color: settings.footer_text_color }} />
                </a>
              )}
              {settings.social_twitter && (
                <a
                  ...
                  aria-label="X"
                >
                  <FaXTwitter className="h-6 w-6" style={{ color: settings.footer_text_color }} />
                </a>
              )}
              {settings.social_pinterest && (
                ...
                >
                  <FaPinterest className="h-6 w-6" style={{ color: settings.footer_text_color }} />
                </a>
              )}
              {settings.social_instagram && (
                ...
                >
                  <Instagram className="h-6 w-6" style={{ color: settings.footer_text_color }} />
                </a>
              )}
              {settings.social_tiktok && (
                <a
                  ...
                  aria-label="TikTok"
                >
                  <FaTiktok className="h-6 w-6" style={{ color: settings.footer_text_color }} />
                </a>
              )}
            </div>
          </div>

          {/* Right Side: Company and Legal Links */}
